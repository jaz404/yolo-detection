...
# make the mask layer
mask = cv2.imread("../Videos/car-mask.jpg")
...
# making a line if body crosses, will be counted
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentCls == 'car' or currentCls == 'truck' or  currentCls == 'car' or currentCls == 'motorbike' or currentCls == 'bus'\
                    and conf > 0.3: # only runs if it is a car and if confidence is > than
